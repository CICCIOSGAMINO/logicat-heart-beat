...
const minUpdatingInterval = 600
const defaultUpdatingInterval = 21600
...
export const startConnectionChecking =
  ...
  // valid number for seconds in interval check
    if (typeof seconds === 'number' &&
      ...
      // run immediate connectionLookupService, after first
      // run handle it with setInterval
      connectionLookupService()
